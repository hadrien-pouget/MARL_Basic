...
# Testing
###
def several_test(env, prior, p1s, p2s):
    """
    Evaluate the policies against the provided prior, using game-specific 
    evaluation method. This may be exact or empirical evaluation.
    """
    all_r1s, all_r2s = [], []
